                    ...
                    <div style={{ padding: '40px', flex: 1 }}>
                        ...
                        <div style={{
                            ...
                            <p style={{ fontSize: '14px', color: '#1e40af', lineHeight: '1.5' }}>
                                Confirmation email sent. Our team will contact you to confirm delivery.
                            </p>
                        </div>

                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '28px' }}>
                            <div style={{ backgroundColor: '#f9fafb', padding: '18px', borderRadius: '10px', border: '1px solid #e5e5e5' }}>
                                <span style={{ display: 'block', fontSize: '12px', color: '#9ca3af', marginBottom: '6px' }}>Payment</span>
